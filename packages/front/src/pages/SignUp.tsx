  ...
  return (
    <PlankL componentChildren={
      <div className='flex flex-col items-start justify-start'>
        ...
        <div className='mb-5'/>
        <h2 className="text-3xl font-bold text-neutral inner-text-shadow-lg font-sans">Je m'enregistre :</h2>
        <div className='mb-4'/>
        <form onSubmit={handleSubmit} className='flex flex-col items-start justify-start'>
          <label className='text-xl font-bold font-sans'>Nom d'utilisateur :</label>
          <div className='mb-2'/>
          <UsernameInput
            onChange={setUsername}
          />
          <div className='mb-3'/>
          <label className='text-xl font-bold font-sans'>Mot de passe :</label>
          <div className='mb-2'/>
          <PasswordInput
            onChange={setPassword}
          />
          <div className='mb-4'/>
          <NeutralButtonXL text="Sign-up" submit={(e) => handleSubmit(e)}/>
        </form>
      </div>
    } />
  );
